...
Upload EVERYTHING in this folder, keeping the folder structure:
  index.html                  the study app, version 2.7.3 (2.3 MB: three.js, SheetJS, JSZip and the two lounge pictures are built in)
...
State of the site on 13 Sep 2026: app 2.7.3 uploaded (it refuses to run a clip that is not
the finished version, and adds a researcher-only "Reset this headset" screen that can save a
full backup of every session, log and setting before anything is erased; see
Project Docs\COPY_TO_HEADSET_AND_BACKUP.txt, COMPUTER_STATION_SETUP_AND_SESSION_GUIDE.txt
and RESEARCHER_QUICK_GUIDE.txt).
