...
Upload EVERYTHING in this folder, keeping the folder structure:
  index.html                  the study app, version 2.6.2 (2.3 MB: three.js, SheetJS, JSZip and the two lounge pictures are built in)
  ...
  audio/narration/*.mp3       Jason's narration (01 and 02 are no longer played by 2.5 but can stay; 14 to 22 are optional and play only when present)
